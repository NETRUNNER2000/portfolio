    ...
    <section className="c-space my-20">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
            <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                ...
                <div className="p-3 backdrop-filter background-blur-3xl w-fit rounded-lg"
                ...
                <div className='flex items-center justify-between flex-wrap gap-5'>
                    ...
                    <a className="flex items-center gap-2 cursor-pointer text-white-600 cursor-pointer" href={currentProject.href} target="_blank" rel="noreferrer">
            ...
            <div className="border border-black-300 bg-black-200 rounded-lg h-96 md:h-full">
                    <Canvas>
                       ...
                       <Center>
                            ...
                            <group scale={2} position={[-0.4,2,-12]} rotation={[0.5,-0.4,0]}>
